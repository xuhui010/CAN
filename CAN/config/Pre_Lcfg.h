...
extern void Pre_StateData_Write(Pre_StateType state, unsigned char data);	//将报文相关数据存入预充状态数据结构体中
extern uint8 Pre_StateData_Fault(void);	//预充故障函数初始化
extern uint8 Pre_StateData_Time(void);	//预充时间函数初始化
